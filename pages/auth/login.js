...
const Login = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      <SEO
        title="Login - Nickel Metal Tracker"
        description="Log in to your Nickel Metal Tracker account to access powerful tools, manage your watchlist, and stay updated with market trends."
        keywords="login, sign in, account access, nickel tracker, investment platform"
      />
          ...
          <div className="relative w-full lg:w-1/2 h-full hidden lg:block">
            ...
            <div className="absolute inset-0 flex flex-col justify-center items-center text-center text-white px-10">
              <h1 className="text-4xl font-bold mb-4">
                Welcome to Nickel Metal Tracker
              </h1>
              <p className="text-base max-w-xl text-white/80 tracking-wide">
                Track and manage your nickel market data effortlessly. Log in to
                access your account and stay ahead of the market.
              </p>
            </div>
          </div>
            ...
            <div className="max-w-md mx-auto w-full">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <button
                  ...
                  className="w-full bg-accent text-white py-2 rounded-sm hover:bg-accent/90 transition-all duration-300 ease-in-out disabled:opacity-60"
                >
