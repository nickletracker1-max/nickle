...
const Signup = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      <SEO
        title="Sign Up - Nickel Metal Tracker"
        description="Create your Nickel Metal Tracker account to access powerful tools, manage your watchlist, and stay updated with nickel market trends."
        keywords="sign up, create account, registration, nickel tracker, investment platform"
      />
          ...
          <div className="relative w-full lg:w-1/2 h-full hidden lg:block">
            ...
            <div className="absolute inset-0 flex flex-col justify-center items-center text-center text-white px-10">
              <h1 className="text-4xl font-bold mb-4">
                Join Nickel Metal Tracker
              </h1>
              <p className="text-base max-w-xl text-white/80 tracking-wide">
                Create your account today and start tracking nickel market data
